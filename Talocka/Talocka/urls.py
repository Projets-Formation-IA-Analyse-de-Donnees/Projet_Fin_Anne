...
urlpatterns = [
    ...
    path('modifier_dataset/<int:projet_id>/<int:dataset_id>', app_1_views.modifier_dataset, name='modifier_dataset'),
    path('dataset/<int:dataset_id>/', app_1_views.dataset_details, name='dataset_details'),
